...
final List<ThemeModel> themes = [
  ...
  ThemeModel(
    ...
    tabBarColor: const Color(0xFF81C784),
    tabBarSelectedItemColor: Colors.white,
    tabBarUnselectedItemColor: const Color(0xFFE0F2F1),
    backgroundImage: 'assets/images/spring.jpg',
    textColor: const Color(0xFF37474F),
    iconColor: const Color(0xFF4DB6AC),
    cardColor: const Color(0xFFFDF7ED),
    appBarColor: const Color(0xFF81C784),
    boxColor: const Color(0xFFFDF7ED).withOpacity(0.85),
  ),
  ...
  ThemeModel(
    ...
    borderColor: Color(0xFF2AA198),
    backgroundColor: Color(0xFFFFF8E7),
    tabBarColor: Color(0xFF00BFA6),
    tabBarSelectedItemColor: Colors.white,
    tabBarUnselectedItemColor: Color(0xFFE0F7F4),
    backgroundImage: 'assets/images/summer.jpg',
    textColor: Color(0xFF2B2B2B),
    iconColor: Color(0xFF00BFA6),
    cardColor: Color(0xFFFFFBF2),
    appBarColor: Color(0xFF00BFA6),
    boxColor: Color(0xFFFFFBF2),
  ),
