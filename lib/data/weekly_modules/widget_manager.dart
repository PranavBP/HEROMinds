...
void openYouTubePlayer(BuildContext context, {
  ...
  Navigator.of(context).push(
    MaterialPageRoute(
      ...
      fullscreenDialog: false, // regular push
    ),
  );
}
...
class YouTubeButton extends StatelessWidget {
  ...
  const YouTubeButton({super.key, required this.title, required this.videoId});
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: SizedBox(
        ...
        child: ElevatedButton.icon(
          onPressed: () =>
              openYouTubePlayer(context, videoId: videoId, title: title),
          icon: const Icon(Icons.play_circle_fill, size: 24),
          label: Text(
            title,
            style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w500),
